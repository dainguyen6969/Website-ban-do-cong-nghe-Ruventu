          ...
          <div className="container nav-container">
            <ul className="nav-links">
              <li className="has-mega-menu">
                <NavLink to="/category/linh-kien" className={({ isActive }) => isActive ? "active" : ""}>Linh Kiện PC</NavLink>
              ...
              <li className="has-mega-menu">
                <NavLink to="/category/gaming-gear" className={({ isActive }) => isActive ? "active" : ""}>Gaming Gear</NavLink>
                <div className="mega-menu">
                  <div className="mega-menu-content">
                    <div className="mega-col">
                      <ul>
              ...
              <li className="has-mega-menu">
                <NavLink to="/category/man-hinh" className={({ isActive }) => isActive ? "active" : ""}>Màn Hình</NavLink>
                <div className="mega-menu">
                  <div className="mega-menu-content">
                    <div className="mega-col">
                      <ul>
              ...
              <li className="has-mega-menu">
                <NavLink to="/category/laptop" className={({ isActive }) => isActive ? "active" : ""}>Laptop</NavLink>
                <div className="mega-menu">
                  <div className="mega-menu-content">
                    <div className="mega-col">
                      <ul>
              ...
              <li className="has-mega-menu">
                <NavLink to="/build-pc" className={({ isActive }) => isActive ? "active" : ""}>Build PC</NavLink>
                <div className="mega-menu">
                  <div className="mega-menu-content">
                    <div className="mega-col">
                      <ul>
              ...
              <li><NavLink to="/promotions" className={({ isActive }) => isActive ? "highlight active" : "highlight"}>Khuyến Mãi</NavLink></li>
              <li><NavLink to="/warranty-lookup" className={({ isActive }) => isActive ? "active" : ""}>Tra Cứu Bảo Hành</NavLink></li>
            </ul>
