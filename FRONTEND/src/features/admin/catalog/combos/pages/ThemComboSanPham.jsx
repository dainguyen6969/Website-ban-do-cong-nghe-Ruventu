...
export default function ThemComboSanPham() {
  ...
  const [form, setForm] = useState({ name: '', code: '', description: '', category: '', brand: '', retail: '', cost: '', active: true, vat: false, vatRate: '10' });
  ...
  return <main className="combo-create-page">
    ...
    <div className="combo-create-grid"><div className="combo-create-main">
      ...
      <FormCard title="Giá"><div className="variant-fields"><div className="combo-field"><label>GIÁ BÁN COMBO <i>*</i></label><div className="unit-input"><PriceInput className={fieldClass(errors.retail)} value={form.retail} onChange={(value) => update('retail', value)} /><span>đ</span></div>{errors.retail && <small>{errors.retail}</small>}</div><div className="combo-field"><label>GIÁ NHẬP <i>*</i></label><div className="unit-input"><PriceInput className={fieldClass(errors.cost)} value={form.cost} onChange={(value) => update('cost', value)} /><span>đ</span></div>{errors.cost && <small>{errors.cost}</small>}</div></div></FormCard>
