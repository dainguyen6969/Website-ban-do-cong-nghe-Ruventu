// Admin product screen: ChiTietSanPham.
...
function warehouses(product) {
  ...
  return [{ name: 'Tổng tồn kho', tonKho: stock, coTheBan: stock, dangVe: 0, location: '—' }];
}
...
export default function ChiTietSanPham() {
  ...
  if (error) return <main className="detail-page"><p>{error}</p><button className="detail-btn detail-btn--outline" onClick={() => navigate('/admin/san-pham/danh-sach-san-pham')}>Quay lại</button></main>;
  if (!product) return <main className="detail-page"><p>Đang tải sản phẩm...</p></main>;
