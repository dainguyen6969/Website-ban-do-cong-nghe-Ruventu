// Admin shipping screen: DoiTacVanChuyen.
...
function PartnerDetail({ partner, successMessage, onBack, onAction }) {
  ...
  const deliveryPagination = useDetailTablePagination(deliveries);
