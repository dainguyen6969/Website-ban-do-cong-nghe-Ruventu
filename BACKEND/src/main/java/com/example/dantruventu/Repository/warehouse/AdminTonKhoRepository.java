...
public interface AdminTonKhoRepository extends JpaRepository<SanPham, Long> {
  ...
  @Query(value = TonKhoSql.FIND_ITEMS, countQuery = TonKhoSql.COUNT_ITEMS, nativeQuery = true)
  ...
  @Query(
      """
            ...
            """)
  Optional<PhienBanSanPham> findVariant(@Param("id") Long id, @Param("loai") LoaiSanPham loai);
  ...
  @Query(
      """
            ...
            """)
  Optional<SanPham> findCombo(@Param("id") Long id, @Param("loai") LoaiSanPham loai);

  @Query(value = TonKhoSql.VARIANT_STOCKS, nativeQuery = true)
  List<StockProjection> findVariantStocks(@Param("id") Long id, @Param("khoHangId") Long khoHangId);

  @Query(value = TonKhoSql.COMBO_STOCKS, nativeQuery = true)
  List<StockProjection> findComboStocks(@Param("id") Long id, @Param("khoHangId") Long khoHangId);

  @Query(value = TonKhoSql.COMPONENTS, nativeQuery = true)
  List<ComponentProjection> findComponents(
      @Param("id") Long id, @Param("khoHangId") Long khoHangId);
