...
public final class NhaCungCapSpecification {
  ...
  public static Specification<NhaCungCap> build(String keyword, TrangThaiCoBanEnum trangThai) {
    ...
    return (root, query, cb) -> {
      ...
      if (keyword != null && !keyword.isBlank()) {
        ...
        predicates.add(
            cb.or(
                cb.like(cb.lower(root.<String>get("maNhaCungCap")), pattern, '!'),
                cb.like(cb.lower(root.<String>get("tenNhaCungCap")), pattern, '!'),
