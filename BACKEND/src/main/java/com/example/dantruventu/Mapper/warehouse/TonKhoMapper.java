...
public interface TonKhoMapper {
  ...
  AdminInventoryDetailResponse.PhienBanData toPhienBan(PhienBanSanPham phienBan);

  AdminInventoryDetailResponse.ComboData toCombo(SanPham sanPham);

  @Mapping(target = "canhBao", source = "canhBao", qualifiedByName = "flag")
  @Mapping(target = "coTonAm", source = "coTonAm", qualifiedByName = "flag")
  AdminInventoryItemResponse toItem(AdminTonKhoRepository.ItemProjection source);

  @Mapping(target = "canhBao", source = "canhBao", qualifiedByName = "flag")
  @Mapping(target = "coTonAm", source = "coTonAm", qualifiedByName = "flag")
  AdminInventoryWarehouseStockResponse toStock(AdminTonKhoRepository.StockProjection source);

  @Mapping(target = "cauHinhHopLe", source = "hopLe", qualifiedByName = "flag")
  ...
  @Mapping(target = "ngayTao", source = "ngayTao", qualifiedByName = "inventoryDate")
  AdminInventoryLedgerResponse toLedger(TheKho theKho, @Context ZoneId zoneId);
  ...
  @Named("inventoryDate")
  default OffsetDateTime inventoryDate(LocalDateTime value, @Context ZoneId zoneId) {
