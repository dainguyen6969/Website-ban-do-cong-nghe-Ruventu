...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductVariantDetailResponse>>
    getProductVariantDetail(
            @PathVariable Long id,
            @PathVariable Long variantId
    ) {

        ProductVariantDetailResponse data =
                productService.getProductVariantDetail(
                        id,
                        variantId
                );
        ...
        ApiResponse<ProductVariantDetailResponse> response =
                ApiResponse
                        .<ProductVariantDetailResponse>builder()
                        .status(200)
                        .message(
